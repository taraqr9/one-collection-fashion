...
Route::middleware('auth')->group(function () {
    ...
    Route::group(['prefix' => 'settings'], function () {
        ...
        Route::group(['prefix' => 'top_banner'], function () {
            ...
            Route::post('/{index}/edit', [TopBannerController::class, 'update']);
            Route::get('/{index}/delete', [TopBannerController::class, 'delete'])->name('settings.top_banner.delete');
        });
        ...
        Route::group(['prefix' => 'mid_banner'], function () {
            ...
            Route::post('/{index}/edit', [MidBannerController::class, 'update'])->name('settings.mid_banner');
            Route::get('/{index}/delete', [MidBannerController::class, 'delete'])->name('settings.mid_banner.delete');
        });
        ...
        Route::group(['prefix' => 'mini_top_banner'], function () {
            ...
            Route::post('/{index}/edit', [MiniTopBannerController::class, 'update'])->name('settings.mini_top_banner');
            Route::get('/{index}/delete', [MiniTopBannerController::class, 'delete'])->name('settings.mini_top_banner.delete');
        });
