...
@section('breadcrumb')
    <span class="breadcrumb-item active">Mid Banner</span>
@endsection
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a onclick="return confirm('Are you sure?')"
                                           href="{{ route("settings.mid_banner.delete", $key) }}"
                ...
                <form action="" method="post" id="banner_form" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <input id="gallery-photo-add" type="file" class="form-control" name="mid_banner">
                        </div>
                    </div>
...
@section('footer_js')
    <script>
        ...
        $('#add_banner_image').click(function (e) {
            ...
            $('#banner_form').attr('action', '/admin/settings/mid_banner');
        });
        ...
        $(document).on("click", "#edit_banner_image", function () {
            ...
            $('#banner_form').attr('action', '/admin/settings/mid_banner/' + id + '/edit');
        });
