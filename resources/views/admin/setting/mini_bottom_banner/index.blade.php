...
@section('breadcrumb')
    <span class="breadcrumb-item active">Mini Bottom Banner</span>
@endsection
                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped text-center">
                            ...
                            <tbody>
                            @forelse($mini_bottom_banners as $key => $banner)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a onclick="return confirm('Are you sure?')"
                                           href="{{ route("settings.mini_bottom_banner.delete", $key) }}"
                ...
                <form action="" method="post" id="banner_form" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <input id="gallery-photo-add" type="file" class="form-control" name="mini_bottom_banner">
                        </div>
                    </div>
...
@section('footer_js')
    <script>
        ...
        $('#add_banner_image').click(function (e) {
            ...
            $('#banner_form').attr('action', '/admin/settings/mini_bottom_banner');
        });
        ...
        $(document).on("click", "#edit_banner_image", function () {
            ...
            $('#banner_form').attr('action', '/admin/settings/mini_bottom_banner/' + id + '/edit');
        });
