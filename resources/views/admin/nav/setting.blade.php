<li class="nav-item nav-item-submenu @if ($page == config('app.nav.top_banner') || $page == config('app.nav.mid_banner') || $page == config('app.nav.footer')) nav-item-open @endif">

    <a href="#" class="nav-link"><i class="ph-gear "></i><span>Setting</span></a>

    <ul class="nav-group-sub collapse  @if($page == config('app.nav.top_banner') || $page == config('app.nav.mid_banner') || $page == config('app.nav.footer')) show @endif">
