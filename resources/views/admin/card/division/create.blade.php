    ...
    <section style="background-color: #ffffff;">
        <div class="container py-5">
            <div class="row justify-content-center align-items-center">
                <form method="post" class="col-lg-8 border rounded-xl p-2" action="{{ url('/cards/division') }}"
                    ...
                    <div class="form-group row m-1">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="name_in_bangla" class="form-control"
                                   placeholder="Division name in Bangla" value="{{ old('name_in_bangla') }}" required>
                        </div>
                    </div>
                    <hr>
                    <div class="form-group row m-1">
                    ...
                    <div class="text-end mt-4">
                        <button type="submit" class="btn btn-outline-primary">Add Division</button>
                    </div>
                </form>
            </div>
        </div>
